...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css"
        integrity="sha512-zN3/izIHa96fa3ssbCgLswNzVYi8pL3ngUzvqCyZ3ByQx7HvcBn1pVQmQV5KJ11wjNU26uB66zH6xM3XgNpFzA=="
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-16">
                <div class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex">
                    <div>
                        <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Laporan Pasien Rajal KUBR</h2>
                        <br>
                        <form action="/laporan" method="post">
                            @csrf
                            <input type="date" name="date1" id="date1" value="{{ date('Y-m-01') }}">
                            <input type="date" name="date2" id="date2" value = "{{ date('Y-m-d') }}"><br><br>
